 ...
 * with the bot
 */
public class TDLib.ShareChatWithBot : TDObject {
     ...
     * If the bot must be a member, then all chats from
     * {@link Client.get_groups_in_common} and all chats, where the user can
     * add the bot, are suitable. In the latter case the bot will be
     * automatically added to the chat.
