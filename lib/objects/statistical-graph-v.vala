 ...
 */
public abstract class TDLib.StatisticalGraphV : Error {}

/**
 * Describes a message sent in the chat
 */
public class TDLib.ChatStatisticsObjectTypeMessage : StatisticalGraphV {
 ...
 */
public class TDLib.ChatStatisticsObjectTypeStory : StatisticalGraphV {
