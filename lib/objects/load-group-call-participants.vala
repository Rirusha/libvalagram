...
/**
 * Loads more participants of a group call; not supported in live
 * stories. The loaded participants will be received through updates.
 * Use the field groupCall.loaded_all_participants to check whether all
