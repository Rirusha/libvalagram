 ...
 * Use setFileGenerationProgress and finishFileGeneration to generate the
 * file
 */
 ...
 * The method setApplicationVerificationToken must be called once the
 * verification is completed or failed
 */
...
public class TDLib.UpdateProfileAccentColors : Update {
    ...
    /**
     * The list of accent color identifiers, which can be set through
     * setProfileAccentColor and setChatProfileAccentColor. The colors must
     * be shown in the specififed order
     */
    public Gee.ArrayList<int32?> available_accent_color_ids { get; construct set; default = new Gee.ArrayList<int32?> (); }
...
public class TDLib.UpdateNewBusinessMessage : Update {
     ...
     * The new message
     */
    public BusinessMessage message { get; construct set; }
